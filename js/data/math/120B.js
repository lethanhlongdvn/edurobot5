export const lesson120B = {
    ...
    "pptLink": "https://docs.google.com/presentation/d/1xqvOZypcAChLpiuNTrOOVpfqac9VITubZjmJkh_5sOQ/embed?start=false&loop=false&delayms=3000",
    "content": `
        ...
        return `
            <div class="space-y-4" id="container-120B">
                ...
                <style>
                    ...
                    .op-sign-120B { position: absolute; left: 8px; top: 75px; font-size: 40px; font-weight: 900; color: #1e3a8a; z-index: 10; pointer-events: none; text-shadow: 2px 2px 0 white; }
                    .line-120B { grid-column: 1 / span 6; height: 4px; background: #1e3a8a; margin-top: -2px; z-index: 5; }
