                                ...
                                if (type !== 'div') {
                                    gridHtml = \`
                                        <div class="flex flex-col items-center">
                                            ...
                                            <button onclick="checkOne120B('\${type}', \${i})" class="mt-2 px-6 py-2 bg-emerald-500 text-white rounded-xl font-black shadow-lg active:scale-95 flex items-center gap-2">Kiểm tra</button>
                                        </div>
                                    \`;
                                } else {
                                    gridHtml = \`
                                        <div class="flex flex-col items-center">
                                            ...
                                            <button onclick="checkOne120B('div', \${i})" class="mt-2 px-6 py-2 bg-amber-500 text-white rounded-xl font-black shadow-lg active:scale-95 flex items-center gap-2">Kiểm tra</button>
                                        </div>
                                    \`;
                                }
