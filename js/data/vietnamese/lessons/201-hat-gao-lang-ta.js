export const lesson_201_hat_gao_lang_ta = {
    "topic": "Tiếng Việt 5",
    "week": "20",
    "period": "201",
    "title": "HẠT GẠO LÀNG TA",
    "desc": "Hạt gạo làng ta",
    "subject": "Đọc",
    "theme": "Vẻ đẹp cuộc sống",
    "audio": "am_thanh/tiengviet/hatgaolangta.wav",
    "content": `
...
`,
    "quizPool": [
    {
        "question": "Bài thơ \"Hạt gạo làng ta\" do nhà thơ nào sáng tác?",
        "options": [
            "Tố Hữu",
            "Trần Đăng Khoa",
            "Phạm Tiến Duật",
    ...
    {
        "question": "Dòng sông nào đã mang nặng phù sa bồi đắp cho hạt gạo làng ta?",
        "options": [
            "Sông Hồng",
            "Sông Đuống",
            "Sông Cửu Long",
    ...
    {
        "question": "Ngoài vị phù sa và hương sen thơm, hạt gạo còn chứa đựng điều gì từ người mẹ?",
        "options": [
            "Lời ru buồn",
    ...
    {
        "question": "Khó khăn thiên nhiên nào được nhắc đến trong khổ thơ thứ hai?",
        "options": [
    ...
    {
        "question": "Hình ảnh \"Nước như ai nấu / Chết cả cá cờ\" gợi tả điều gì?",
        "options": [
            "Nước sông bị ô nhiễm",
            "Người dân đang nấu nước sôi",
            "Cái nắng nóng khắc nghiệt của trưa tháng Sáu",
    ...
    {
        "question": "Trước nắng nóng làm \"cua ngoi lên bờ\", hình ảnh người mẹ hiện lên như thế nào?",
        "options": [
            "Mẹ nghỉ ngơi dưới bóng cây",
            "Mẹ em xuống cấy",
            "Mẹ về nhà tránh nắng",
            "Mẹ ngồi quạt mát cho con"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Khổ thơ thứ ba nhắc đến bối cảnh lịch sử nào?",
        "options": [
    ...
    {
        "question": "Trong chiến tranh, hạt gạo đã theo người đi xa như thế nào?",
        "options": [
            "Bát cơm mùa gặt thơm hào giao thông",
            "Được chở bằng xe tải lớn",
            "Được cất giấu kỹ trong kho",
            "Chỉ dùng nuôi quân ở hậu phương"
        ],
        "answer": 0,
        "level": 1
    },
    {
        "question": "Các bạn nhỏ đã góp công làm ra hạt gạo bằng việc gì?",
        "options": [
            "Đi học và trông em",
            "Nấu cơm giúp mẹ",
    ...
    {
        "question": "Câu thơ \"Quang trành quết đất\" nói lên điều gì về các bạn nhỏ?",
        "options": [
            "Các bạn nhỏ rất ham chơi",
            "Sự vất vả, nỗ lực lao động dù tuổi còn nhỏ",
            "Làm hỏng dụng cụ lao động",
            "Đất ngoài đồng rất dính"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Hạt gạo làm ra được gửi đi đâu?",
        "options": [
            "Chỉ để ăn trong gia đình",
    ...
    {
        "question": "Vì sao tác giả gọi hạt gạo là \"hạt vàng\"?",
        "options": [
            "Vì hạt gạo màu vàng óng",
            "Vì hạt gạo bán rất nhiều tiền",
            "Vì nó rất quý giá, chứa đựng mồ hôi công sức",
            "Vì lúa chín trông như vàng"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Bài thơ ca ngợi phẩm chất nào của người nông dân?",
        "options": [
            "Cần cù, chịu khó, yêu lao động",
            "Thông minh, sáng tạo",
            "Vui vẻ, lạc quan",
            "Dũng cảm chiến đấu"
        ],
    ...
    {
        "question": "Hình ảnh thể hiện sự kết tinh của đất trời trong hạt gạo?",
        "options": [
            "Giọt mồ hôi sa",
    ...
    {
        "question": "Qua bài thơ, tác giả muốn nhắc nhở chúng ta lòng gì?",
        "options": [
            "Tiết kiệm nước",
            "Chăm chỉ học tập",
            "Biết ơn nông dân và trân trọng hạt gạo",
            "Yêu thiên nhiên"
        ],
        "answer": 2,
        "level": 1
...
if (!lesson_201_hat_gao_lang_ta.period) lesson_201_hat_gao_lang_ta.period = "201";
if (!lesson_201_hat_gao_lang_ta.id) lesson_201_hat_gao_lang_ta.id = "201-hat-gao-lang-ta";
