export const lesson_192_khuc_hat_ru = {
    "topic": "Tiếng Việt 5",
    "week": "19",
    "period": "192",
    "title": "KHÚC HÁT RU NHỮNG EM BÉ LỚN TRÊN LƯNG MẸ",
    "desc": "Khúc hát ru những em bé lớn trên lưng mẹ",
    "subject": "Đọc",
    "theme": "Vẻ đẹp cuộc sống",
    "audio": "am_thanh/tiengviet/khuchatrunhungemlontrenlungme.wav",
    "content": `
...
`,
    "quizPool": [
    {
        "question": "Tác giả của bài thơ \"Khúc hát ru những em bé lớn trên lưng mẹ\" là ai?",
        "options": [
            "Tố Hữu",
            "Trần Đăng Khoa",
            "Nguyễn Khoa Điềm",
    ...
    {
        "question": "Em bé được nhắc đến trong bài thơ có tên là gì?",
        "options": [
            "A-lưi",
            "Cu Tai",
            "Ka-lưi",
    ...
    {
        "question": "Trong khổ thơ đầu, người mẹ làm công việc gì?",
        "options": [
            "Tỉa bắp",
            "Dệt vải",
            "Giã gạo",
    ...
    {
        "question": "Mục đích chính của việc mẹ giã gạo là gì?",
        "options": [
            "Để bán lấy tiền",
            "Chuẩn bị bữa tối",
    ...
    {
        "question": "Câu thơ \"Nhịp chày nghiêng giấc ngủ em nghiêng\" gợi tả điều gì?",
        "options": [
            "Cái chày bị cong",
            "Giấc ngủ của em bé theo nhịp lao động của mẹ",
            "Em bé đang nằm võng",
            "Mẹ đang ru trên giường"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Hình ảnh nào diễn tả sự gian khổ của mẹ tác động đến em bé?",
        "options": [
            "Lưng đưa nôi",
            "Tim hát thành lời",
    ...
    {
        "question": "Trong lời ru ở khổ 1, mẹ mong ước con mơ thấy điều gì?",
        "options": [
            "Mặt trời",
            "Hạt gạo trắng ngần",
            "Núi Ka-lưi",
    ...
    {
        "question": "Câu thơ \"Mai sau con lớn vung chày lún sân\" thể hiện mong muốn gì?",
        "options": [
            "Con là nông dân giỏi",
            "Con lớn lên khỏe mạnh giúp ích nước nhà",
            "Con sửa lại cái sân",
            "Con đi bộ đội ngay"
        ],
        "answer": 1,
    ...
    {
        "question": "Ở khổ thơ thứ hai, người mẹ làm công việc gì?",
        "options": [
            "Giã gạo bên suối",
            "Hái rau trong rừng",
            "Làm rẫy trên nương",
    ...
    {
        "question": "Hình ảnh đối lập nào làm nổi bật sự nhỏ bé nhưng kiên cường của mẹ?",
        "options": [
            "Mặt trời to - nhỏ",
    ...
    {
        "question": "Trong câu \"Mặt trời của bắp thì nằm trên đồi\", hình ảnh \"mặt trời\" có nghĩa là gì?",
        "options": [
    ...
    {
        "question": "Câu \"Mặt trời của mẹ, em nằm trên lưng\" sử dụng BPNT gì?",
        "options": [
            "So sánh",
            "Ẩn dụ",
            "Nhân hóa",
    ...
    {
        "question": "Vì sao tác giả gọi em bé là \"Mặt trời của mẹ\"?",
        "options": [
            "Mặt em tròn",
            "Em mặc áo đỏ",
            "Em là niềm tin, nguồn sống của mẹ",
            "Em thức dậy sớm"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Công việc giã gạo, tỉa bắp của mẹ có ý nghĩa gì?",
        "options": [
            "Quên nỗi buồn",
            "Góp phần nuôi quân kháng chiến",
            "Rèn luyện sức khỏe",
            "Dạy con lao động"
        ],
        "answer": 1,
    ...
    },
    {
        ...
        "options": [
            "Vẻ đẹp thiên nhiên",
            "Quy trình lao động",
            "Tình yêu con hòa quyện tình yêu đất nước",
            "Tuổi thơ gian khổ"
        ],
        "answer": 2,
        "level": 1
...
if (!lesson_192_khuc_hat_ru.period) lesson_192_khuc_hat_ru.period = "192";
if (!lesson_192_khuc_hat_ru.id) lesson_192_khuc_hat_ru.id = "192-khuc-hat-ru";
