export const lesson_321_bai_ca_trai_dat = {
    "topic": "Tiếng Việt 5",
    "week": "32",
    "period": "321",
    "title": "BÀI CA TRÁI ĐẤT",
    "desc": "Bài ca Trái Đất",
    "subject": "Đọc",
    "theme": "Thế giới của chúng ta",
    "audio": "am_thanh/tiengviet/bai-ca-trai-dat.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/bai-ca-trai-dat.png" alt="Bài ca Trái Đất" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Bài thơ 'Bài ca Trái Đất' được viết bởi tác giả nào?",
        "options": [
            "Trần Đăng Khoa",
            "Định Hải",
            "Lâm Thị Mỹ Dạ",
    ...
    {
        "question": "Trái đất được so sánh với hình ảnh nào trong khổ thơ đầu?",
        "options": [
            "Đĩa bay",
            "Quả cam",
            "Quả bóng xanh",
    ...
    {
        "question": "Những loài chim nào được nhắc đến trong bài thơ?",
        "options": [
            "Bồ câu, Hải âu",
            "Đại bàng, Sẻ",
            "Vàng anh, Chào mào",
    ...
    {
        "question": "Tiếng chim bồ câu gù gợi lên điều gì?",
        "options": [
            "Sự ồn ào",
            "Thương mến",
            "Sự sợ hãi",
    ...
    {
        "question": "Màu da của các bạn trẻ năm châu được kể tên là gì?",
        "options": [
            "Hồng, xanh, tím",
            "Vàng, trắng, đen",
            "Đỏ, cam, vàng",
    ...
    {
        "question": "Tác giả gọi các bạn nhỏ là gì của đất?",
        "options": [
            "Là nụ, là hoa",
            "Là lá, là cành",
            "Là rễ, là thân",
    ...
    {
        "question": "Nắng được nhân hóa để làm gì cho các loài hoa?",
        "options": [
            "Tưới nước",
            "Tô thắm sắc",
            "Che chở",
    ...
    {
        "question": "Hình ảnh nào được coi là tai họa?",
        "options": [
            "Mây ngũ sắc",
            "Khói hình nấm",
            "Cầu vồng",
    ...
    {
        "question": "Bom H, bom A được bài thơ nhận định như thế nào?",
        "options": [
            "Là bạn tốt",
            "Là đồ chơi",
            "Không phải bạn ta",
    ...
    {
        "question": "Tiếng hát có vai trò gì?",
        "options": [
            "Làm ồn",
            "Giữ bình yên trái đất",
            "Dọa chim",
            "Gọi mưa"
        ],
        "answer": 1,
    ...
    {
        "question": "Tiếng cười có tác dụng gì?",
        "options": [
            "Làm mọi người vui",
            "Cho trái đất không già",
            "Giải trí",
            "Chữa bệnh"
        ],
        "answer": 1,
    ...
    {
        "question": "Câu 'Cùng bay nào, cho trái đất quay' thể hiện điều gì?",
        "options": [
            "Sức mạnh đoàn kết và khát vọng hòa bình",
            "Muốn bay lên trời",
            "Muốn đi du lịch",
            "Thích tập thể dục"
        ],
    ...
    },
    {
        ...
        "options": [
            "Bảo vệ môi trường",
            "Yêu hòa bình, chống chiến tranh",
            "Khám phá vũ trụ",
            "Trồng nhiều hoa"
        ],
        "answer": 1,
    ...
    {
        "question": "Hành tinh này là của ai?",
        "options": [
            "Của người lớn",
            "Của chúng ta (trẻ em)",
    ...
    {
        "question": "Câu thơ nào khẳng định sự bình đẳng giữa các dân tộc?",
        "options": [
...
if (!lesson_321_bai_ca_trai_dat.period) lesson_321_bai_ca_trai_dat.period = "321";
if (!lesson_321_bai_ca_trai_dat.id) lesson_321_bai_ca_trai_dat.id = "321-bai-ca-trai-dat";
