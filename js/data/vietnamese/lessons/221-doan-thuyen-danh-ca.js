export const lesson_221_doan_thuyen_danh_ca = {
    "topic": "Tiếng Việt 5",
    "week": "22",
    "period": "221",
    "title": "ĐOÀN THUYỀN ĐÁNH CÁ",
    "desc": "Đoàn thuyền đánh cá",
    "subject": "Đọc",
    "theme": "Vẻ đẹp cuộc sống",
    "audio": "am_thanh/tiengviet/doanthuyendanhca.mp3",
    "content": `
...
`,
    ...
    {
        "question": "Trong khổ thơ đầu, \"Mặt trời xuống biển\" được so sánh với gì?",
        "options": [
            "Quả cầu lửa",
            "Hòn lửa",
            "Hòn than",
    ...
    {
        "question": "Biện pháp nghệ thuật nào được sử dụng trong câu \"Sóng đã cài then, đêm sập cửa\"?",
        "options": [
            "So sánh",
            "Nhân hóa",
            "Điệp từ",
    ...
    {
        "question": "Âm thanh nào cùng đoàn thuyền căng buồm ra khơi?",
        "options": [
            "Tiếng sóng vỗ",
            "Tiếng còi tàu",
            "Câu hát",
    ...
    {
        "question": "Trong câu \"Cá thu Biển Đông như đoàn thoi\", tác giả tả loài cá nào?",
        "options": [
            "Cá bạc",
            "Cá nục",
            "Cá chim",
    ...
    {
        "question": "Ngư dân \"hát bài ca gọi cá vào\" với ý nghĩa gì?",
        "options": [
            "Xua đuổi thú dữ",
            "Xua tan mệt nhọc và cầu mong bội thu",
            "Thông báo vị trí",
            "Ru ngủ biển"
        ],
        "answer": 1,
    ...
    {
        "question": "Hình ảnh \"Biển cho ta cá như lòng mẹ\" thể hiện điều gì?",
        "options": [
            "Sợ hãi thiên nhiên",
    ...
    },
    {
        ...
        "options": [
            "Đang tập thể dục",
            "Vẻ đẹp khỏe khoắn và mẻ lưới nặng",
            "Vất vả đau đớn",
            "Sợ bão"
        ],
        "answer": 1,
    ...
    {
        "question": "Màu sắc nào mô tả cảnh rạng đông trong khổ 4?",
        "options": [
            "Vảy bạc",
            "Đuôi vàng",
            "Nắng hồng",
    ...
    {
        "question": "Ý nghĩa của câu thơ \"Đoàn thuyền chạy đua cùng mặt trời\" là gì?",
        "options": [
            "Chạy trốn nắng",
            "Khí thế hào hùng, khẩn trương lao động",
            "Thi thể thao",
            "Bị đuổi"
        ],
        "answer": 1,
    ...
    {
        "question": "Bài thơ \"Đoàn thuyền đánh cá\" ca ngợi vẻ đẹp nào?",
        "options": [
            "Thuyền hiện đại",
            "Con người yêu lao động và biển khơi huy hoàng",
            "Biển đêm đáng sợ",
            "Bầu trời sao"
        ],
        "answer": 1,
    ...
    },
    {
        ...
        "options": [
            "Buồn man mác",
            "Lo lắng hiểm nguy",
            "Vui tươi, lạc quan, hăng say lao động",
            "Cô đơn"
        ],
        "answer": 2,
        "level": 1
...
if (!lesson_221_doan_thuyen_danh_ca.period) lesson_221_doan_thuyen_danh_ca.period = "221";
if (!lesson_221_doan_thuyen_danh_ca.id) lesson_221_doan_thuyen_danh_ca.id = "221-doan-thuyen-danh-ca";
