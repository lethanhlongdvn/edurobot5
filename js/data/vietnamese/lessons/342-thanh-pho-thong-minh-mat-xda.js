export const lesson_342_thanh_pho_thong_minh_mat_xda = {
    "topic": "Tiếng Việt 5",
    "week": "34",
    "period": "342",
    "title": "THÀNH PHỐ THÔNG MINH MÁT-XĐA",
    "desc": "Thành phố thông minh Mát-xđa",
    "subject": "Đọc",
    "theme": "Thế giới của chúng ta",
    "audio": "am_thanh/tiengviet/342-mat-xda.mp3",
    "content": `
...
`,
    ...
    {
        "question": "Mát-xđa được xây dựng ở đâu?",
        "options": [
            "Trên núi cao",
            "Dưới lòng đất",
            "Giữa sa mạc",
    ...
    {
        "question": "Dự án khởi công năm nào?",
        "options": [
            "2000",
            "2005",
            "2008",
    ...
    {
        "question": "Mục tiêu của Mát-xđa là gì?",
        "options": [
            "Thành phố giàu nhất",
            "Thành phố không các-bô-níc đầu tiên",
            "Thành phố lớn nhất",
            "Thành phố du lịch"
        ],
        "answer": 1,
    ...
    {
        "question": "Điểm nhấn thiết kế của thành phố là gì?",
        "options": [
            "Kim tự tháp",
            "Những chiếc ô hình hoa hướng dương",
            "Tòa nhà cao tầng",
            "Công viên nước"
        ],
        "answer": 1,
    ...
    {
        "question": "Những chiếc ô khổng lồ làm gì vào ban ngày?",
        "options": [
            "Tạo mưa",
            "Lưu trữ năng lượng và che nắng",
            "Phát sáng",
            "Quay theo chiều gió"
        ],
        "answer": 1,
    ...
    {
        "question": "Những chiếc ô khổng lồ làm gì vào ban đêm?",
        "options": [
            "Ngủ đông",
            "Khép lại, tỏa nhiệt, cung cấp điện",
            "Biến mất",
            "Chiếu phim"
        ],
        "answer": 1,
    ...
    {
        "question": "Các tòa nhà được thiết kế như thế nào để giảm nóng?",
        "options": [
            "Xây cách xa nhau",
            "Chụm lại, có lối đi ở giữa",
            "Sơn màu đen",
            "Không có cửa sổ"
        ],
        "answer": 1,
    ...
    {
        "question": "Tháp gió có tác dụng gì?",
        "options": [
            "Trang trí",
            "Lấy gió mát trên cao thổi vào thành phố",
    ...
    {
        "question": "Công viên ở đây xây theo mô hình nào?",
        "options": [
            "Vườn Châu Âu",
            "Vườn Ả Rập truyền thống",
            "Rừng nguyên sinh",
            "Vườn Nhật Bản"
        ],
        "answer": 1,
    ...
    {
        "question": "Phương tiện giao thông nào được khuyến khích?",
        "options": [
            "Ô tô chạy xăng",
            "Xe buýt chạy dầu",
            "Xe đạp, đi bộ, xe điện",
            "Xe máy"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Mát-xđa đã truyền cảm hứng cho những nước nào?",
        "options": [
            "Mỹ và Pháp",
            "Anh, Bồ Đào Nha...",
            "Trung Quốc và Nga",
    ...
    {
        "question": "Mát-xđa là hình mẫu cho loại đô thị nào?",
        "options": [
            "Đô thị cổ",
            "Đô thị sinh thái",
            "Đô thị công nghiệp",
    ...
    {
        "question": "Vì sao Mát-xđa được gọi là thành phố thông minh?",
        "options": [
            "Vì người dân thông minh",
            "Sử dụng công nghệ để bảo vệ môi trường",
            "Có nhiều robot",
            "Có trường đại học lớn"
        ],
        "answer": 1,
        "level": 1
    },
...
if (!lesson_342_thanh_pho_thong_minh_mat_xda.period) lesson_342_thanh_pho_thong_minh_mat_xda.period = "342";
if (!lesson_342_thanh_pho_thong_minh_mat_xda.id) lesson_342_thanh_pho_thong_minh_mat_xda.id = "342-thanh-pho-thong-minh-mat-xda";
