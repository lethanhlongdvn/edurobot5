export const lesson_282_nguoi_thay_cua_muon_doi = {
    "topic": "Tiếng Việt 5",
    "week": "28",
    "period": "282",
    "title": "NGƯỜI THẦY CỦA MUÔN ĐỜI",
    "desc": "Người thầy của muôn đời",
    "subject": "Đọc",
    "theme": "Tiếp bước cha ông",
    "audio": "am_thanh/tiengviet/282-nguoi-thay-cua-muon-doi.mp3",
    "content": `
...
<div class="flex flex-col lg:flex-row gap-6"> 
                                ...
                                <aside class="w-full lg:w-[30%]"> 
                                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl">
                                        <div class="mb-6">
                                            <img src="hinh_anh/tiengviet/nguoithaycuamuondoi.png" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl">
                                        </div>
...
`,
    "quizPool": [
    {
        "question": "Thầy giáo Chu Văn An sống vào triều đại nào?",
        "options": [
            "Triều Lý",
            "Triều Trần",
            "Triều Lê",
    ...
    {
        "question": "Sau khi thi đỗ cao, Chu Văn An đã lựa chọn con đường nào?",
        "options": [
            "Ra làm quan to trong triều đình ngay lập tức",
            "Đi du ngoạn khắp nơi",
            "Không làm quan mà mở trường dạy học ở quê",
            "Ở ẩn và không gặp gỡ ai"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Mục đích mở trường dạy học của Chu Văn An là gì?",
        "options": [
            "Để kiếm sống",
            "Nhằm truyền bá đạo lí và đào tạo nhân tài cho đất nước",
            "Để được nổi tiếng",
            "Để chuẩn bị thi tiếp"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Các môn sinh đến nhà cụ giáo Chu để làm gì?",
        "options": [
            "Để học bài",
            "Để xin chữ",
            "Để mừng thọ thầy",
    ...
    {
        "question": "Món quà mà các môn sinh dâng biếu thầy là gì?",
        "options": [
            "Vàng bạc, châu báu",
            "Lụa là, gấm vóc",
            "Những cuốn sách quý do họ tự sưu tầm và chép lại",
            "Những bức tranh quý"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Thái độ của các môn sinh đối với cụ giáo Chu như thế nào?",
        "options": [
            "Sợ hãi và xa lánh",
            "Kính trọng, yêu mến và biết ơn",
            "Thờ ơ, không quan tâm",
            "Coi thường vì thầy không làm quan"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Chi tiết nào thể hiện sự đồng lòng và lễ phép của các học trò khi nghe thầy đề nghị?",
        "options": [
            "Họ im lặng nhìn nhau",
            "Họ bàn tán xôn xao",
            "Họ dạ ran và kính cẩn đi theo sau cụ",
            "Họ xin phép ra về"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Người mà cụ giáo Chu mời học trò cùng đến thăm là ai?",
        "options": [
            "Một người bạn cũ của cụ",
            "Một vị quan to trong triều",
            "Người thầy dạy vỡ lòng cho cụ ngày xưa",
            "Một người học trò giỏi nhất của cụ"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Hành động dẫn học trò đi thăm thầy cũ của cụ giáo Chu thể hiện truyền thống đạo đức nào?",
        "options": [
            "Lá lành đùm lá rách",
    ...
    {
        "question": "Vì sao tác giả gọi Chu Văn An là \"Người thầy của muôn đời\"?",
        "options": [
            "Vì cụ sống rất lâu",
            "Vì cụ có rất nhiều học trò",
            "Vì cụ là tấm gương mẫu mực về đạo đức và nhân cách cho mọi thế hệ học trò noi theo",
            "Vì cụ dạy học ở nhiều nơi"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Cụm từ \"dạy vỡ lòng\" có nghĩa là gì?",
        "options": [
            "Dạy những kiến thức đầu tiên, cơ bản nhất cho người mới bắt đầu học",
            "Dạy những kiến thức cao siêu, khó hiểu",
            "Dạy võ thuật",
            "Dạy cách làm thơ"
        ],
        "answer": 0,
    ...
    {
        "question": "Theo bài đọc, yếu tố nào giúp cụ Chu Văn An có được thành công và dạy dỗ được nhiều học trò giỏi?",
        "options": [
            "Nhờ cụ có nhiều tiền",
            "Nhờ cụ có quyền lực",
            "Nhờ công ơn dạy dỗ của người thầy cũ và sự nỗ lực của bản thân",
            "Nhờ sự may mắn"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Bài học sâu sắc nhất mà cụ giáo Chu muốn dạy cho các học trò qua buổi mừng thọ là gì?",
        "options": [
            "Phải học thật giỏi để làm quan",
            "Phải tặng quà đắt tiền cho thầy",
            "Phải biết trân trọng, nhớ ơn và kính trọng những người thầy đã dạy dỗ mình",
    ...
    {
        "question": "Tình cảm của các thế hệ học trò dành cho Chu Văn An được miêu tả như thế nào trong phần kết?",
        "options": [
            "Chỉ kính trọng khi thầy còn sống",
            "Yêu mến, kính trọng và coi ông là tấm gương sáng mãi",
            "Bình thường như những người thầy khác",
            "Kính sợ vì thầy rất nghiêm khắc"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Dòng nào dưới đây nêu đúng nghĩa của từ \"tề tựu\"?",
        "options": [
            "Đi lại lộn xộn",
            "Đứng xếp hàng ngay ngắn",
            "Tụ họp lại đông đủ tại một nơi",
            "Giải tán đi nhiều nơi"
        ],
        "answer": 2,
        "level": 1
    }
...
if (!lesson_282_nguoi_thay_cua_muon_doi.period) lesson_282_nguoi_thay_cua_muon_doi.period = "282";
if (!lesson_282_nguoi_thay_cua_muon_doi.id) lesson_282_nguoi_thay_cua_muon_doi.id = "282-nguoi-thay-cua-muon-doi";
