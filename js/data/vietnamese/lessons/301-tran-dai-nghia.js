export const lesson_301_tran_dai_nghia = {
    "topic": "Tiếng Việt 5",
    "week": "30",
    "period": "301",
    "title": "ANH HÙNG LAO ĐỘNG TRẦN ĐẠI NGHĨA",
    "desc": "Anh hùng Lao động Trần Đại Nghĩa",
    "subject": "Đọc",
    "theme": "Tiếp bước cha ông",
    "audio": "am_thanh/tiengviet/301-tran-dai-nghia.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/tran-dai-nghia.png" alt="Anh hùng Lao động Trần Đại Nghĩa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Tên thật của Anh hùng Lao động Trần Đại Nghĩa là gì?",
        "options": [
            "Trần Văn Giàu",
            "Phạm Quang Lễ",
            "Tôn Thất Tùng",
    ...
    {
        "question": "Ông theo Bác Hồ về nước vào năm nào?",
        "options": [
            "1945",
            "1946",
            "1954",
    ...
    {
        "question": "Trước khi về nước, cuộc sống của ông ở nước ngoài như thế nào?",
        "options": [
    ...
    {
        "question": "Động lực nào khiến ông từ bỏ tất cả để về nước?",
        "options": [
            "Muốn tìm cơ hội làm giàu",
            "Lòng yêu nước and mong muốn cống hiến for sự nghiệp giải phóng dân tộc",
            "Bị trục xuất khỏi nước ngoài",
            "Muốn đi du lịch"
        ],
        "answer": 1,
        "level": 1
    ...
    {
        "question": "Ông đã cùng đồng nghiệp nghiên cứu and chế tạo thành công loại vũ khí nào dưới đây?",
        "options": [
            "Xe tăng",
            "Máy bay chiến đấu",
            "Súng ba-dô-ca",
    ...
    {
        "question": "Ngoài súng ba-dô-ca, loại súng nào khác được nhắc đến trong bài?",
        "options": [
            "Súng lục",
            "Súng không giật",
            "Súng trường",
    ...
    {
        "question": "Bài đọc nhận định Trần Đại Nghĩa là một tấm gương lớn về điều gì?",
        "options": [
            "Về sự giàu có",
            "Về lòng yêu nước and tinh thần lao động vì đất nước",
            "Về khả năng ngoại ngữ",
            "Về sức khỏe phi thường"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Nội dung chính của bài đọc là gì?",
        "options": [
            "Kể về quá trình đi học của Phạm Quang Lễ",
            "Ca ngợi tài năng, lòng yêu nước and những cống hiến to lớn của Anh hùng Lao động Trần Đại Nghĩa",
            "Giới thiệu cách chế tạo súng ba-dô-ca",
            "Miêu tả cuộc sống ở nước ngoài của ông"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Quê của Trần Đại Nghĩa ở tỉnh nào?",
        "options": [
            "Bến Tre",
            "Vĩnh Long",
            "Trà Vinh",
    ...
    {
        "question": "Ông được cấp học bổng đi du học tại nước nào vào năm 1935?",
        "options": [
            "Anh",
            "Pháp",
            "Đức",
    ...
    {
        "question": "Tại Pháp, ông đã theo học những ngành kỹ sư nào?",
        "options": [
            "Xây dựng, Kiến trúc",
            "Cầu cống, Điện, Hàng không",
            "Hóa chất, Dệt may",
            "Khai thác mỏ"
        ],
        "answer": 1,
    ...
    {
        "question": "Năm 1948, ông được phong quân hàm gì?",
        "options": [
            "Đại tá",
            "Thiếu tướng",
            "Trung tướng",
    ...
    {
        "question": "Năm 1952, ông được tuyên dương danh hiệu gì?",
        "options": [
            "Chiến sĩ thi đua",
            "Anh hùng Lao động",
            "Nhà giáo Ưu tú",
    ...
    {
        "question": "Giải thưởng danh giá nào do Nhà nước tặng ông được nhắc đến trong bài?",
        "options": [
            "Giải thưởng Lê-nin",
    ...
    {
        "question": "Trần Đại Nghĩa có đóng góp gì trong việc xây dựng nền khoa học nước nhà?",
        "options": [
            "Ông viết sách giáo khoa",
            "Ông xây dựng nền khoa học trẻ tuổi của nước nhà",
            "Ông phát minh ra động cơ hơi nước",
            "Ông tìm ra nhiều loài cây mới"
        ],
        "answer": 1,
        "level": 1
    }
...
if (!lesson_301_tran_dai_nghia.period) lesson_301_tran_dai_nghia.period = "301";
if (!lesson_301_tran_dai_nghia.id) lesson_301_tran_dai_nghia.id = "301-tran-dai-nghia";
