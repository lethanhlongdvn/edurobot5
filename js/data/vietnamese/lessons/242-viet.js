export const lesson_242_viet = {
    ...
    "tabs": {
        ...
        "quiz": {
            "settings": { "pick": 3 },
            "questions": [
                { "q": "Khi đánh giá đoạn văn về cảm xúc, tiêu chí nào là quan trọng nhất?", "a": ["Độ dài của bài", "Sử dụng từ ngữ thể hiện tình cảm, cảm xúc phù hợp", "Kể lại thật nhiều sự việc", "Tả trang phục"], "c": 1 },
                { "q": "Lỗi 'lạc ý' trong văn cảm xúc nghĩa là gì?", "a": ["Viết đúng trọng tâm", "Viết quá ngắn", "Viết sang kể chuyện hoặc tả cảnh mà quên bộc lộ cảm xúc", "Nộp bài muộn"], "c": 2 },
                { "q": "Để câu văn hay hơn khi tả hoạt động, em nên làm gì?", "a": ["Chỉ dùng động từ", "Thêm các từ ngữ biểu cảm, suy nghĩ chân thành", "Chép lại y hệt mẫu", "Viết câu cực dài"], "c": 1 }
            ]
        }
    }
};
