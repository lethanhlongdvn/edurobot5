export const lesson_341_dien_thoai_di_dong = {
    "topic": "Tiếng Việt 5",
    "week": "34",
    "period": "341",
    ...
    "audio": "am_thanh/tiengviet/341-dien-thoai-di-dong.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <!-- Ảnh minh họa -->
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/dien_thoai_di_dong.png" alt="Minh họa Điện thoại di động" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Ai là người thực hiện cuộc gọi di động đầu tiên?",
        "options": [
            "Mác-tin Cúp-pơ",
            "A-lếch-xan-đơ Gra-ham Bell",
            "Xti-vờ Gióp",
            "Tô-mát Ê-đi-xơn"
        ],
        "answer": 0,
    ...
    {
        "question": "Cuộc gọi đầu tiên được thực hiện vào năm nào?",
        "options": [
            "1950",
            "1960",
            "1973",
    ...
    {
        "question": "Chiếc điện thoại đầu tiên nặng bao nhiêu?",
        "options": [
            "0,5 ki-lô-gam",
            "1,1 ki-lô-gam",
            "2 ki-lô-gam",
    ...
    {
        "question": "Vì sao chiếc điện thoại đầu tiên được gọi là 'cục gạch'?",
        "options": [
            "Vì nó rất cứng",
            "Vì nó hình vuông",
            "Vì nó to và nặng như cục gạch",
            "Vì nó màu đỏ"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Pin của chiếc điện thoại đầu tiên dùng được bao lâu?",
        "options": [
            "1 tiếng",
            "20 phút",
            "5 phút",
    ...
    {
        "question": "Điện thoại ngày nay nặng khoảng bao nhiêu?",
        "options": [
            "Chưa đến 85 gam",
            "100 gam",
            "200 gam",
    ...
    {
        "question": "Điện thoại di động ngày nay được ví với vật dụng gì?",
        "options": [
            "Cái máy tính",
            "Hộp dụng cụ đa năng",
            "Cái ti vi",
    ...
    {
        "question": "Ngoài nghe gọi, điện thoại ngày nay làm được gì?",
        "options": [
            "Nấu cơm",
            "Giặt đồ",
            "Chụp ảnh, xem phim, định vị...",
            "Quét nhà"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Hệ thống nào giúp điện thoại xác định vị trí?",
        "options": [
    ...
    {
        "question": "Lợi ích chính của điện thoại di động là gì?",
        "options": [
            "Làm đồ chơi",
            "Liên lạc nhanh chóng, tiện lợi",
            "Để trang trí",
            "Để chặn giấy"
        ],
        "answer": 1,
    ...
    {
        "question": "Nếu không có điện thoại, điều gì sẽ khó khăn nhất?",
        "options": [
            "Xem giờ",
            "Nghe nhạc",
            "Liên lạc khẩn cấp/tức thời",
            "Chơi game"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Điện thoại di động giúp con người tiết kiệm điều gì?",
        "options": [
            "Tiền bạc",
    ...
    {
        "question": "Màn hình của chiếc thoại đầu tiên hiển thị được gì?",
        "options": [
            "Hình ảnh màu",
            "Video",
            "Chỉ hiển thị chữ",
    ...
    {
        "question": "Tác giả bài đọc là ai?",
        "options": [
            "Gim Píp",
            "Nam Cao",
            "Tô Hoài",
    ...
    {
        "question": "Chủ điểm của bài học là gì?",
        "options": [
            "Thế giới tuổi thơ",
            "Vẻ đẹp cuộc sống",
...
if (!lesson_341_dien_thoai_di_dong.period) lesson_341_dien_thoai_di_dong.period = "341";
if (!lesson_341_dien_thoai_di_dong.id) lesson_341_dien_thoai_di_dong.id = "341-dien-thoai-di-dong";
