export const lesson_211_gio_hoa_thang_nam = {
    "topic": "Tiếng Việt 5",
    "week": "21",
    "period": "211",
    "title": "GIỎ HOA THÁNG NĂM",
    "desc": "Giỏ hoa tháng Năm",
    "subject": "Đọc",
    "theme": "Vẻ đẹp cuộc sống",
    "audio": "am_thanh/tiengviet/giohoathangnam.mp3",
    "content": `
...
<div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <aside class="w-full lg:w-[30%]">
                                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                                        <div class="mb-6 -mt-2">
                                            <img src="hinh_anh/tiengviet/giohoathangnam.png" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                                        </div>
...
`,
    "quizPool": [
    {
        "question": "Ngày lễ Mừng xuân vào tháng Năm các bạn nhỏ thường làm gì?",
        "options": [
            "Làm những giỏ hoa rực rỡ mang tặng người thân, bạn bè",
            "Đi du xuân cùng bố mẹ",
            "Tổ chức cắm trại ở trường",
    ...
    {
        "question": "Các bạn nhỏ tặng hoa cho người thân, bạn bè bằng cách nào?",
        "options": [
            "Gửi qua bưu điện",
            "Đưa tận tay chủ nhà",
            "Đặt lên bậc thềm, gõ cửa rồi ba chân bốn cẳng chạy trốn",
            "Nhờ bố mẹ mang đến tặng"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Tại sao Xu-di lại giận Pam?",
        "options": [
            "Vì Pam không tặng hoa cho Xu-di",
            "Vì Pam có thêm bạn mới và không dành nhiều thời gian cho Xu-di",
            "Vì Pam làm hỏng đồ chơi của Xu-di",
            "Vì Pam chuyển nhà đi nơi khác"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Khi thấy Xu-di buồn vì giận bạn, mẹ đã làm gì?",
        "options": [
            "Mắng Xu-di vì tính hay dỗi",
            "Khuyên Xu-di nên tìm bạn mới",
            "Ôm ấp, an ủi và khuyên nhủ Xu-di về tình bạn",
            "Bảo Xu-di không nên chơi với Pam nữa"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Theo lời mẹ, Xu-di đã học được điều gì về tình bạn?",
        "options": [
            "Càng lớn sẽ càng có nhiều bạn, không thể chỉ chơi với một người",
            "Bạn bè phải luôn ở bên cạnh nhau mọi lúc mợi nơi",
            "Chỉ nên chơi với một người bạn thân duy nhất",
            "Không nên giận dỗi bạn bè lâu"
        ],
        "answer": 0,
        "level": 1
    },
    {
        "question": "Xu-di đã tặng Pam giỏ hoa có màu gì?",
        "options": [
            "Màu đỏ",
            "Màu xanh",
            "Màu vàng",
    ...
    {
        "question": "Tại sao Xu-di lại chọn hoa màu đó để tặng Pam?",
        "options": [
            "Vì đó là màu hoa mẹ Xu-di thích",
            "Vì đó là màu hoa Pam yêu thích",
            "Vì trong vườn chỉ có duy nhất loại hoa đó",
            "Vì hoa đó rẻ nhất"
        ],
        "answer": 1,
        "level": 1
    ...
    {
        "question": "Pam đã làm gì khi nhận được giỏ hoa của Xu-di?",
        "options": [
            "Mang vào nhà cất ngay",
            "Nâng giỏ hoa lên, áp mặt vào hoa và nói lời cảm ơn",
            "Chia cho người bạn mới cùng ngắm",
            "Cất vào một góc vì vẫn còn giận Xu-di"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Câu nói: 'hi vọng cậu không còn giận mình' của Pam cho thấy điều gì?",
        "options": [
            "Pam không biết Xu-di đang giận",
            "Pam rất trân trọng tình bạn với Xu-di và mong muốn làm hòa",
            "Pam muốn Xu-di phải xin lỗi mình",
            "Pam đang trêu chọc Xu-di"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Bài học quan trọng nhất về tình bạn mà Xu-di rút ra ở cuối truyện là gì?",
        "options": [
            "Phải luôn tặng quà cho bạn vào các ngày lễ",
            "Bạn bè đích thực là đặt bạn trong tim nhưng không buộc họ luôn ở bên mình",
            "Chỉ nên chơi với những người bạn thích hoa màu vàng",
            "Không bao giờ được giận bạn thân"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Từ 'bí mật' trong câu 'Chúng tôi thường bí mật làm những giỏ hoa rực rỡ' thuộc từ loại nào?",
        "options": [
            "Danh từ",
            "Động từ",
            "Tính từ",
    ...
    {
        "question": "Từ 'rực rỡ' trong bài có nghĩa là gì?",
        "options": [
            "Có màu sắc tươi sáng, đẹp mắt và nổi bật",
            "Có mùi thơm ngào ngạt",
            "Rất to lớn",
            "Rất đắt tiền"
        ],
        "answer": 0,
    ...
    {
        "question": "Trong câu 'Tôi và Pam thân nhau như hình với bóng', tác giả sử dụng biện pháp nghệ thuật gì?",
        "options": [
            "Nhân hóa",
            "So sánh",
            "Điệp ngữ",
    ...
    {
        "question": "Từ nào đồng nghĩa với từ 'đích thực'?",
        "options": [
            "Giả tạo",
            "Chân thực",
            "Hờ hững",
    ...
    {
        "question": "Câu văn 'Mẹ dịu dàng vuốt tóc và lau nước mắt cho tôi' thuộc kiểu câu nào?",
        "options": [
            "Câu kể",
            "Câu hỏi",
            "Câu cảm",
...
if (!lesson_211_gio_hoa_thang_nam.period) lesson_211_gio_hoa_thang_nam.period = "211";
if (!lesson_211_gio_hoa_thang_nam.id) lesson_211_gio_hoa_thang_nam.id = "211-gio-hoa-thang-nam";
