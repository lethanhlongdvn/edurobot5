export const lesson_312_viet_nam_que_huong_ta = {
    "topic": "Tiếng Việt 5",
    "week": "31",
    "period": "312",
    "title": "VIỆT NAM QUÊ HƯƠNG TA",
    "desc": "Việt Nam quê hương ta",
    "subject": "Đọc",
    "theme": "Tiếp bước cha ông",
    "audio": "am_thanh/tiengviet/viet-nam-que-huong-ta.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/viet-nam-que-huong-ta.png" alt="Việt Nam quê hương ta" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Tác giả của bài thơ 'Việt Nam quê hương ta' là ai?",
        "options": [
            "Tố Hữu",
            "Nguyễn Khoa Điềm",
            "Nguyễn Đình Thi",
    ...
    {
        "question": "Hình ảnh 'Mênh mông biển lúa' gợi lên điều gì?",
        "options": [
            "Sự giàu có, trù phú của đồng bằng Việt Nam",
            "Biển có màu vàng",
            "Nông dân trồng nhiều lúa",
            "Cảnh thiếu nước"
        ],
        "answer": 0,
        "level": 1
    ...
    {
        "question": "Điền từ còn thiếu: 'Cánh cò bay ____ rập rờn'?",
        "options": [
            "cao",
            "thấp",
            "lả",
    ...
    {
        "question": "Đỉnh núi nào được nhắc đến trong câu 'Mây mờ che đỉnh ____ sớm chiều'?",
        "options": [
            "Hoàng Liên Sơn",
            "Trường Sơn",
            "Ba Vì",
    ...
    {
        "question": "Hình ảnh 'Mặt người vất vả in sâu' nói lên phẩm chất gì?",
        "options": [
            "Lười biếng",
    ...
    {
        "question": "Trang phục truyền thống của người nông dân được nhắc đến là gì?",
        "options": [
            "Áo lụa",
            "Áo dài",
            "Áo nâu",
    ...
    {
        "question": "'Đất nghèo nuôi những anh hùng' thể hiện truyền thống gì?",
        "options": [
    ...
    {
        "question": "Hành động 'Đạp quân thù xuống đất đen' thể hiện điều gì?",
        "options": [
            "Sự tàn bạo",
            "Sức mạnh và ý chí kiên cường chống giặc",
            "Tập thể dục",
            "Làm đồng"
        ],
        "answer": 1,
    ...
    {
        "question": "Sau khi chiến tranh kết thúc ('Súng gươm vứt bỏ'), con người Việt Nam trở nên như thế nào?",
        "options": [
            "Hung dữ",
            "Lại hiền như xưa",
            "Kiêu ngạo",
    ...
    {
        "question": "'Đất nắng chan hòa' gợi tả khí hậu như thế nào?",
        "options": [
            "Lạnh giá quanh năm",
            "Mưa dầm dề",
            "Nhiều nắng, ấm áp",
    ...
    {
        "question": "Đất nước ta có hoa thơm quả ngọt vào lúc nào?",
        "options": [
            "Chỉ mùa xuân",
            "Chỉ mùa hè",
            "Bốn mùa",
    ...
    {
        "question": "Vẻ đẹp của cô gái Việt Nam được miêu tả qua chi tiết nào?",
        "options": [
            "Tóc dài",
            "Da trắng",
            "Mắt đen long lanh",
    ...
    {
        "question": "Phẩm chất tình cảm nào của người Việt Nam được ca ngợi trong câu 'Yêu ai yêu trọn tấm tình thủy chung'?",
        "options": [
            "Hay thay đổi",
            "Thủy chung, son sắt",
            "Lạnh lùng",
    ...
    {
        "question": "Câu 'Tay người như có phép tiên' ca ngợi điều gì?",
        "options": [
            "Người Việt Nam biết làm ảo thuật",
            "Sự khéo léo, tài hoa của đôi bàn tay người lao động",
            "Người Việt Nam có sức mạnh siêu nhiên",
            "Tay người rất đẹp"
        ],
        "answer": 1,
        "level": 1
    ...
    {
        "question": "Nghệ thuật nổi bật được sử dụng trong bài thơ là gì?",
        "options": [
            "So sánh, nhân hóa, thể thơ lục bát uyển chuyển",
            "Kể chuyện",
            "Văn xuôi",
            "Phỏng vấn"
        ],
...
if (!lesson_312_viet_nam_que_huong_ta.period) lesson_312_viet_nam_que_huong_ta.period = "312";
if (!lesson_312_viet_nam_que_huong_ta.id) lesson_312_viet_nam_que_huong_ta.id = "312-viet-nam-que-huong-ta";
