export const lesson_311_ve_ngoi_nha_dang_xay = {
    "topic": "Tiếng Việt 5",
    "week": "31",
    "period": "311",
    "title": "VỀ NGÔI NHÀ ĐANG XÂY",
    "desc": "Về ngôi nhà đang xây",
    "subject": "Đọc",
    "theme": "Tiếp bước cha ông",
    "audio": "am_thanh/tiengviet/ve-ngoi-nha-dang-xay.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/ve-ngoi-nha-dang-xay.png" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Tác giả của bài thơ 'Về ngôi nhà đang xây' là ai?",
        "options": [
            "Trần Đăng Khoa",
            "Lâm Thị Mỹ Dạ",
            "Đồng Xuân Lan",
    ...
    {
        "question": "Các bạn nhỏ đi qua ngôi nhà xây dở vào thời điểm nào?",
        "options": [
            "Sáng sớm đi học",
            "Chiều đi học về",
            "Buổi trưa hè",
    ...
    {
        "question": "Giàn giáo được so sánh với hình ảnh nào?",
        "options": [
            "Cái lồng che chở",
            "Khu rừng rậm",
            "Mạng nhện khổng lồ",
    ...
    {
        "question": "Trụ bê tông nhú lên được ví như cái gì?",
        "options": [
            "Cây nấm",
            "Mầm cây",
            "Ngọn tháp",
    ...
    {
        "question": "Bác thợ nề làm hành động gì với các bạn nhỏ?",
        "options": [
            "Vẫy tay chào",
            "Huơ huơ cái bay chào tạm biệt",
            "Gọi các bạn lại chơi",
            "La mắng các bạn"
        ],
        "answer": 1,
        "level": 1
    ...
    {
        "question": "Ngôi nhà được miêu tả 'thở' ra mùi gì?",
        "options": [
            "Mùi hoa sữa",
            "Mùi vôi vữa nồng hăng",
            "Mùi gỗ mới",
            "Mùi sơn"
        ],
        "answer": 1,
    ...
    {
        "question": "Ngôi nhà đang xây được so sánh với một tác phẩm nghệ thuật nào sắp làm xong?",
        "options": [
            "Bức tượng",
            "Bài thơ",
            "Khúc nhạc",
    ...
    {
        "question": "Ngôi nhà là bức tranh còn nguyên màu gì?",
        "options": [
            "Màu xanh đỏ",
            "Màu vôi, gạch",
            "Màu vàng",
    ...
    {
        "question": "Bầy chim mang đến điều gì cho ngôi nhà?",
        "options": [
            "Rác",
            "Vài nốt nhạc (tiếng hót)",
            "Hạt giống",
            "Lông chim"
        ],
        "answer": 1,
    ...
    {
        "question": "Nắng được nhân hóa đang làm gì trên những bức tường?",
        "options": [
            "Nhảy múa",
            "Ngủ quên",
            "Chạy trốn",
    ...
    {
        "question": "Làn gió mang hương ủ đầy vào đâu?",
        "options": [
            "Vào cửa sổ",
            "Vào rãnh tường chưa trát vữa",
            "Vào mái nhà",
            "Vào sân"
        ],
        "answer": 1,
    ...
    {
        "question": "Câu thơ 'Bao ngôi nhà đã hoàn thành / Đều qua những ngày xây dở' có ý nghĩa gì?",
        "options": [
            "Mọi thành công đều phải trải qua quá trình lao động vất vả, rèn luyện",
            "Xây nhà rất lâu",
            "Không nên xây nhà dở dang",
    ...
    {
        "question": "Ở khổ cuối, ngôi nhà được so sánh với hình ảnh nào?",
        "options": [
            "Người khổng lồ",
            "Trẻ nhỏ",
            "Cây cổ thụ",
    ...
    {
        "question": "Ngôi nhà 'lớn lên' với điều gì?",
        "options": [
            "Với đất nâu",
            "Với trời xanh",
            "Với mây trắng",
    ...
    {
        "question": "Bài thơ ca ngợi điều gì?",
        "options": [
            "Vẻ đẹp của thiên nhiên",
            "Sự đổi mới, phát triển hằng ngày của đất nước",
            "Công việc của bác thợ nề",
...
if (!lesson_311_ve_ngoi_nha_dang_xay.period) lesson_311_ve_ngoi_nha_dang_xay.period = "311";
if (!lesson_311_ve_ngoi_nha_dang_xay.id) lesson_311_ve_ngoi_nha_dang_xay.id = "311-ve-ngoi-nha-dang-xay";
