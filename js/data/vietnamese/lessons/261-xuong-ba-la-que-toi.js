export const lesson_261_xuong_ba_la_que_toi = {
    "topic": "Tiếng Việt 5",
    "week": "26",
    "period": "261",
    "title": "XUỒNG BA LÁ QUÊ TÔI",
    "desc": "Xuồng ba lá quê tôi",
    "subject": "Đọc",
    "theme": "Hương sắc trăm miền",
    "audio": "am_thanh/tiengviet/xuongbala.mp3",
    "content": `
...
<div class="flex flex-col lg:flex-row gap-6">
                                ...
                                <aside class="w-full lg:w-[30%]">
                                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl">
                                        <div class="mb-6"><img src="hinh_anh/tiengviet/xuongbala.png" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl"></div>
...
`,
    "quizPool": [
    {
        "question": "Tác giả của bài văn \"Xuồng ba lá quê tôi\" là ai?",
        "options": [
            "Sơn Nam",
            "Nguyễn Chí Ngoan",
            "Đoàn Giỏi",
    ...
    {
        "question": "Vì sao loại xuồng này được gọi là \"xuồng ba lá\"?",
        "options": [
            "Vì nó nhẹ như ba chiếc lá",
            "Vì nó thường chở lá dừa",
            "Vì nó được ghép bởi ba tấm ván (2 ván be, 1 ván đáy)",
            "Vì nó có hình dáng giống chiếc lá"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Bộ khung bên trong lòng xuồng được tạo hình giống cái gì?",
        "options": [
            "Hình con thoi",
            "Hình xương cá",
            "Hình cánh cung",
    ...
    {
        "question": "Chiếc \"cong\" được đóng vào lòng xuồng có tác dụng gì?",
        "options": [
            "Để trang trí cho đẹp",
            "Để làm chỗ ngồi",
            "Để giúp xuồng được vững chắc",
            "Để gác mái chèo"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Hình ảnh người nội chèo xuồng gắn liền với những món quà quê nào?",
        "options": [
            "Bánh lá dừa, giỏ cua đồng",
            "Bánh tét, con cá lóc",
            "Bông súng, mớ tép",
            "Trái cây chín, bó rau"
        ],
        "answer": 0,
        "level": 1
    },
    {
        "question": "Người chị trong kỉ niệm của tác giả thường chèo xuồng đi hái loại hoa nào?",
        "options": [
            "Bông súng",
            "Bông sen",
            "Bông điên điển",
    ...
    {
        "question": "Bông điên điển mang về thường được má dùng để nấu món gì?",
        "options": [
            "Kho cá",
            "Xào tỏi",
            "Nấu canh chua",
    ...
    {
        "question": "Tác giả ví von chiếc xuồng là gì của người dân Nam Bộ từ thuở mở cõi?",
        "options": [
            "Ngôi nhà di động",
            "Đôi chân của người dân Nam Bộ",
    ...
    {
        "question": "Trong những năm tháng chiến tranh, chiếc xuồng đã thực hiện nhiệm vụ gì?",
        "options": [
            "Chở vũ khí hạng nặng",
            "Chở lương thực tiếp tế, đưa du kích qua sông",
            "Làm lá chắn đạn",
            "Chở quân đi xâm lược"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Khi đất nước thanh bình, xuồng ba lá xuất hiện ở những hoạt động nào?",
        "options": [
            "Chỉ nằm im ở bến sông",
            "Ngược xuôi miền chợ nổi, lướt trên đồng lúa, đi giăng câu thả lưới",
            "Được đưa vào bảo tàng",
            "Chỉ dùng để chở khách du lịch"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Bài đọc nhắc đến vùng đất nào của nước ta?",
        "options": [
            "Tây Bắc",
            "Tây Nguyên",
            "Nam Bộ",
    ...
    {
        "question": "Câu văn \"Xuồng lướt nhanh trên cánh đồng rì rào sóng lúa\" gợi tả cảnh gì?",
        "options": [
            "Mùa gặt lúa",
            "Mùa nước nổi (nước ngập đồng ruộng)",
            "Mùa cấy lúa",
            "Mùa hạn hán"
        ],
        "answer": 1,
    ...
    {
        "question": "Theo bài đọc, mỗi sớm mai, những chiếc xuồng tỏa đi chở theo điều gì mang ý nghĩa tinh thần?",
        "options": [
            "Chở đầy tôm cá",
            "Chở đầy hoa trái",
            "Chở đầy ước mơ, khát vọng của tình đất, tình người phương Nam",
            "Chở đầy ánh nắng ban mai"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Nhận định nào sau đây đúng nhất về vai trò của xuồng ba lá?",
        "options": [
            "Là phương tiện giải trí cuối tuần",
            "Là vật dụng trang trí trong nhà",
            "Là phương tiện di chuyển thiết thân, gắn bó với đời sống, chiến đấu và lao động",
            "Là phương tiện chỉ dùng trong chiến tranh"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Qua bài đọc, em cảm nhận được tình cảm gì của tác giả?",
        "options": [
            "Nỗi sợ hãi sông nước",
            "Tình yêu tha thiết, niềm tự hào và sự gắn bó sâu sắc với quê hương miền sông nước",
            "Sự tiếc nuối về quá khứ",
            "Mong muốn rời xa quê hương"
        ],
        "answer": 1,
        "level": 1
    }
...
if (!lesson_261_xuong_ba_la_que_toi.period) lesson_261_xuong_ba_la_que_toi.period = "261";
if (!lesson_261_xuong_ba_la_que_toi.id) lesson_261_xuong_ba_la_que_toi.id = "261-xuong-ba-la-que-toi";
