export const lesson_302_bo_doi_ve_lang = {
    "topic": "Tiếng Việt 5",
    "week": "30",
    "period": "302",
    ...
    "audio": "am_thanh/tiengviet/302-bo-doi-ve-lang.mp3",
    "content": `
...
`,
    "quizPool": [
    {
        "question": "Tác giả của bài thơ 'Bộ đội về làng' là ai?",
        "options": [
            "Tố Hữu",
            "Chính Hữu",
            "Hoàng Trung Thông",
    ...
    {
        "question": "Khi các anh bộ đội đi xa, thái độ của người dân xóm làng như thế nào?",
        "options": [
            "Lo lắng and sợ hãi",
            "Nhớ mãi and vẫn chờ mong",
            "Buồn bã and tuyệt vọng",
    ...
    {
        "question": "Các anh bộ đội trở về làng từ đâu?",
        "options": [
            "Từ thành phố lớn",
            "Từ miền biển xa",
            "Từ rừng sâu, lưng đèo, dốc núi mù che",
            "Từ nước ngoài"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "Từ ngữ nào miêu tả không khí 'xóm nhỏ' khi bộ đội về?",
        "options": [
            "Vắng lặng",
            "Rộn ràng",
            "Ồn ào",
    ...
    {
        "question": "Mẹ già coi các anh bộ đội như thế nào?",
        "options": [
            "Khách quý",
            "Đàn con ở rừng sâu mới về",
            "Những người hùng",
            "Những người lạ"
        ],
        "answer": 1,
    ...
    {
        "question": "Ngôi nhà đón các anh về được miêu tả ra sao?",
        "options": [
            "Nhà ngói đỏ tươi",
            "Nhà cao cửa rộng",
            "Nhà lá đơn sơ",
            "Biệt thự khang trang"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Bộ đội and dân làng đã làm gì khi gặp nhau bên bát nước chè xanh?",
        "options": [
            "Tổ chức liên hoan văn nghệ",
            "Bàn kế hoạch đánh giặc",
    ...
    },
    {
        ...
        "options": [
            "Ca ngợi vẻ đẹp của thiên nhiên miền núi",
            "Ca ngợi tình quân dân thắm thiết, sự gắn bó bền chặt giữa tiền tuyến and hậu phương",
            "Miêu tả sự vất vả của nghề nông",
            "Kể về chiến công oanh liệt của bộ đội"
        ],
        "answer": 1,
        "level": 1
    },
    {
        "question": "Hình ảnh 'đàn em hớn hở theo sau' thể hiện điều gì?",
        "options": [
            "Sự sợ hãi của trẻ em",
            "Sự yêu mến, vui mừng của trẻ em khi bộ đội về",
            "Trẻ em đang đi học",
            "Trẻ em đang đi chơi"
        ],
        "answer": 1,
    ...
    {
        "question": "Từ 'bịn rịn' trong câu 'Mẹ già bịn rịn áo nâu' thể hiện tình cảm gì?",
        "options": [
            "Sự tức giận",
            "Sự thờ ơ",
            "Sự xúc động, yêu thương, không muốn rời xa",
            "Sự lo lắng"
        ],
        "answer": 2,
        "level": 1
    ...
    {
        "question": "'Bát nước chè xanh' trong bài thơ tượng trưng for điều gì?",
        "options": [
            "Sự giàu sang",
            "Sự giản dị, chân thành and ấm áp của tình quân dân",
            "Sự mệt mỏi",
            "Sự cầu kỳ"
        ],
        "answer": 1,
    ...
    {
        "question": "Bài thơ được viết theo thể thơ nào?",
        "options": [
            "Thơ lục bát",
            "Thơ bốn chữ",
            "Thơ tự do",
    ...
    {
        "question": "Khổ thơ đầu tiên nhắc đến điều gì?",
        "options": [
            "Cảnh đẹp của làng quê",
            "Nỗi nhớ and sự chờ mong của dân làng đối với bộ đội",
    ...
    {
        "question": "Cảnh bộ đội về làng được miêu tác với không khí như thế nào?",
        "options": [
            "Vắng lặng, buồn bã",
            "Tưng bừng, rộn ràng như ngày hội",
            "Căng thẳng, lo âu",
    ...
    {
        "question": "Tình cảm giữa bộ đội and dân làng được ví như tình cảm gì?",
        "options": [
            "Tình bạn xã giao",
...
if (!lesson_302_bo_doi_ve_lang.period) lesson_302_bo_doi_ve_lang.period = "302";
if (!lesson_302_bo_doi_ve_lang.id) lesson_302_bo_doi_ve_lang.id = "302-bo-doi-ve-lang";
