export const lesson_331_mot_nguoi_hung_tham_lang = {
    "topic": "Tiếng Việt 5",
    "week": "33",
    "period": "331",
    "title": "MỘT NGƯỜI HÙNG THẦM LẶNG",
    "desc": "Một người hùng thầm lặng",
    "subject": "Đọc",
    "theme": "Thế giới của chúng ta",
    "audio": "am_thanh/tiengviet/mot-nguoi-hung-tham-lang.mp3",
    "content": `
<div class="flex flex-col lg:flex-row gap-6">
                ...
                <aside class="w-full lg:w-[30%]">
                    <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                        <div class="mb-6 -mt-2">
                            <img src="hinh_anh/tiengviet/mot-nguoi-hung-tham-lang.png" alt="Một người hùng thầm lặng" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                        </div>
...
`,
    "quizPool": [
    {
        "question": "Ông Uyn-tơn là người nước nào?",
        "options": [
            "Anh",
            "Tiệp Khắc",
            "Mỹ",
    ...
    {
        "question": "Ông Uyn-tơn thực hiện công việc giải cứu vào thời gian nào?",
        "options": [
            "Những năm 1938 - 1939",
            "Năm 1945",
            "Năm 1988",
    ...
    {
        "question": "Đối tượng mà ông Uyn-tơn muốn cứu là ai?",
        "options": [
            "Những đứa trẻ Do Thái",
            "Những người lính",
            "Những người già",
            "Những nghệ sĩ"
        ],
    ...
    {
        "question": "Địa điểm giải cứu những đứa trẻ là từ đâu?",
        "options": [
            "Luân Đôn",
            "Pra-ha (Tiệp Khắc)",
            "Hà Lan",
    ...
    {
        "question": "Ông Uyn-tơn đã tổ chức bao nhiêu chuyến tàu giải cứu?",
        "options": [
            "5 chuyến",
            "6 chuyến",
            "8 chuyến",
    ...
    {
        "question": "Số lượng trẻ em được ông Uyn-tơn cứu sống là bao nhiêu?",
        "options": [
            "500 em",
            "669 em",
            "1000 em",
    ...
    {
        "question": "Vì sao hoạt động giải cứu phải kết thúc vào tháng 9 năm 1939?",
        "options": [
            "Hết tiền",
            "Chiến tranh nổ ra, biên giới bị đóng cửa",
            "Ông bị bắt",
            "Ông bị ốm"
        ],
        "answer": 1,
    ...
    {
        "question": "Ông Uyn-tơn đã giữ bí mật về việc làm của mình trong bao lâu?",
        "options": [
            "10 năm",
            "20 năm",
            "50 năm",
    ...
    {
        "question": "Ai là người đã phát hiện ra bí mật của ông Uyn-tơn?",
        "options": [
            "Một nhà báo",
            "Vợ của ông",
            "Một đứa trẻ được cứu",
            "Một người bạn"
        ],
        "answer": 1,
        "level": 1
    ...
    {
        "question": "Ông Uyn-tơn được mọi người biết đến rộng rãi nhờ sự kiện gì năm 1988?",
        "options": [
            "Một chương trình truyền hình",
            "Ông viết sách",
            "Ông nhận giải thưởng Nobel",
            "Ông trả lời phỏng vấn báo chí"
        ],
        "answer": 0,
        "level": 1
    },
    {
        "question": "Khi gặp lại những người mình đã cứu, ông Uyn-tơn có cảm xúc gì?",
        "options": [
            "Bình thản",
            "Tự hào",
            "Nghẹn ngào, xúc động",
    ...
    {
        "question": "Người dân Tiệp Khắc đã làm gì để tưởng nhớ ông?",
        "options": [
            "Đặt tên đường",
            "Dựng tượng ông trên sân ga Pra-ha",
            "Xây trường học",
            "Làm phim"
        ],
        "answer": 1,
    ...
    {
        "question": "Ông Uyn-tơn qua đời năm bao nhiêu tuổi?",
        "options": [
            "90 tuổi",
            "100 tuổi",
            "106 tuổi",
    ...
    {
        "question": "Vì sao gọi ông Uyn-tơn là 'người hùng thầm lặng'?",
        "options": [
            "Vì ông làm việc tốt mà không khoe khoang",
            "Vì ông ít nói",
            "Vì ông làm việc ban đêm",
            "Vì ông thích sự yên tĩnh"
        ],
        "answer": 0,
        "level": 1
    },
    {
        ...
        "options": [
            "Ca ngợi lòng dũng cảm và nhân hậu",
            "Thông tin về chiến tranh thế giới",
            "Kể về lịch sử nước Anh",
            "Tuyên truyền du lịch Tiệp Khắc"
        ],
        "answer": 0,
        "level": 1
    }
...
if (!lesson_331_mot_nguoi_hung_tham_lang.period) lesson_331_mot_nguoi_hung_tham_lang.period = "331";
if (!lesson_331_mot_nguoi_hung_tham_lang.id) lesson_331_mot_nguoi_hung_tham_lang.id = "331-mot-nguoi-hung-tham-lang";
