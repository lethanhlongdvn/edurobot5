                        ...
                        <section class="w-full">
                            <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl relative overflow-hidden ring-1 ring-blue-100">
                                ...
                                <p class="text-[11px] text-blue-500 font-bold mb-4 italic flex items-center gap-1">
                                    <span>💡 Mẹo: Nhấn nút 🎙️ cạnh ô nhập liệu để trả lời bằng giọng nói.</span>
                                </p>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="flex items-center gap-3 mb-4">
                                        <button onclick="checkParagraph('block-231-ex1')" class="px-5 py-2 bg-blue-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-blue-700 transition-all active:scale-95 flex items-center gap-2">
                                    ...
                                    <div class="bg-blue-50/30 rounded-2xl p-4 border border-blue-100">
                                        <p class="text-blue-700 font-bold mb-2 text-sm italic flex items-center gap-2">Trả lời câu b: <button onclick="toggleSpeech('ai-231-ex1b')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs" title="Nhập bằng giọng nói">🎙️</button></p>
                                        ...
                                        <div class="mt-2 flex items-center gap-3">
                                            <button onclick="checkEx1bAI()" class="px-5 py-2 bg-indigo-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-indigo-700 transition-all active:scale-95 flex items-center gap-2">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mt-3 flex items-center gap-3">
                                        <button onclick="checkEx231_2()" class="px-5 py-2 bg-amber-500 text-white text-sm font-bold rounded-xl shadow-md hover:bg-amber-600 transition-all active:scale-95 flex items-center gap-2">
                                            <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-amber-500 font-black text-[10px] shadow-sm">E</div>
                                            <span>KIỂM TRA</span>
                                        </button>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="bg-white/90 rounded-2xl p-4 shadow-sm border border-green-100" id="block-231-ex3a" data-feedback-correct="Từ đàn lặp lại có tác dụng liên kết câu." data-feedback-wrong="Bạn chọn sai rồi, thử lại nhé!">
                                        ...
                                        <div class="mt-2 flex items-center gap-3 border-t border-green-50 pt-3">
                                            <button onclick="checkParagraph('block-231-ex3a')" class="px-5 py-2 bg-green-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-green-700 active:scale-95 transition-all flex items-center gap-2">
                                    ...
                                    <div class="bg-white/90 rounded-2xl p-4 shadow-sm border border-green-100" id="block-231-ex3b" data-feedback-correct="Từ lá, cây sau sau lặp lại có tác dụng liên kết câu." data-feedback-wrong="Bạn chọn sai rồi, thử lại nhé!">
                                        ...
                                        <div class="mt-2 flex items-center gap-3 border-t border-green-50 pt-3">
                                            <button onclick="checkParagraph('block-231-ex3b')" class="px-5 py-2 bg-green-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-green-700 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-green-600 font-black text-[10px] shadow-sm">E</div>
                                                <span>KIỂM TRA (b)</span>
                                            </button>
                                    ...
                                    <div class="bg-white/90 rounded-2xl p-4 shadow-sm border border-green-100" id="block-231-ex3c" data-feedback-correct="Từ chú lặp lại có tác dụng liên kết câu." data-feedback-wrong="Bạn chọn sai rồi, thử lại nhé!">
                                        ...
                                        <div class="mt-2 flex items-center gap-3 border-t border-green-50 pt-3">
                                            <button onclick="checkParagraph('block-231-ex3c')" class="px-5 py-2 bg-green-600 text-white text-sm font-bold rounded-xl shadow-md hover:bg-green-700 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-green-600 font-black text-[10px] shadow-sm">E</div>
                        ...
                        <section class="w-full pb-8">
                            <div class="glass-card rounded-[32px] p-4 md:p-6 shadow-xl border-t-4 border-rose-500">
                                ...
                                <div class="bg-rose-50/50 rounded-2xl p-4 border border-rose-100">
                                    <p class="text-lg font-bold text-gray-700 mb-3 border-l-4 border-rose-400 pl-3 italic flex items-center gap-3">
                                        <span>Viết 2-3 câu về một lễ hội, trong đó các câu liên kết với nhau bằng cách lặp từ ngữ.</span>
                                        <button onclick="toggleSpeech('ai-231-q4')" class="p-2 bg-rose-100 text-rose-600 rounded-full hover:bg-rose-200 transition-all text-sm shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                    </p>
