export const lesson_202_hop_qua_mau_thien_thanh = {
    "topic": "Tiếng Việt 5",
    "week": "20",
    "period": "202",
    "title": "HỘP QUÀ MÀU THIÊN THANH",
    "desc": "Hộp quà màu thiên thanh",
    "subject": "Đọc",
    "theme": "Vẻ đẹp cuộc sống",
    "audio": "am_thanh/tiengviet/hopquamauthienthanh.wav",
    "content": `
                        ...
                        <div class="flex flex-col lg:flex-row gap-6">
                            ...
                            <aside class="w-full lg:w-[30%]">
                                <div class="glass-card rounded-[40px] p-6 sticky top-28 shadow-xl border-amber-100/50">
                                    <div class="mb-6 -mt-2">
                                        <img src="hinh_anh/tiengviet/hop-qua-mau-thien-thanh.png" alt="Minh họa" class="w-full h-auto rounded-3xl object-contain drop-shadow-xl transform hover:scale-105 transition-transform duration-500">
                                    </div>
...
`,
    "quizPool": [
    {
        "question": "Dự định đặc biệt của lớp Tân là gì?",
        "options": [
            "Tặng cô một bó hoa",
            "Tặng cô một chiếc hộp quà chứa 35 lá thư",
    ...
    {
        "question": "Ai là người thông báo ý tưởng quà tặng cho Tân?",
        "options": [
            "Cô chủ nhiệm",
            "Quang và Huệ",
            "Cả lớp",
    ...
    {
        "question": "Tân đi học muộn một lần vì lí do gì?",
        "options": [
            "Ngủ quên",
            "Mải bẻ ngô giúp mẹ",
            "Hỏng xe",
    ...
    {
        "question": "Bạn Huệ đã giải thích giúp Tân như thế nào?",
        "options": [
            "Tân bị ốm",
            "Chắc Tân lại giúp mẹ làm vườn",
            "Tân hỏng xe",
            "Tân không cố ý"
        ],
        "answer": 1,
    ...
    {
        "question": "Cô giáo đã nói gì khi biết Tân giúp mẹ?",
        "options": [
            "Phạt Tân vì đi học muộn",
            "Khen Tân thương mẹ và khuyên đi học đúng giờ",
            "Không nói gì",
            "Yêu cầu Tân xin lỗi"
        ],
        "answer": 1,
    ...
    {
        "question": "Tân đã thay đổi như thế nào sau lời khuyên của cô?",
        "options": [
            "Dậy sớm hơn để học bài",
            "Cố gắng đạt nhiều tiến bộ",
    ...
    {
        "question": "Chiếc hộp màu thiên thanh dùng để làm gì?",
        "options": [
            "Để đựng phấn",
            "Đựng 35 lá thư bí mật tặng cô giáo",
    ...
    {
        "question": "Cô giáo đã mặc gì vào buổi tổng kết?",
        "options": [
            "Áo sơ mi trắng",
            "Áo dài màu thiên thanh",
            "Váy hoa",
            "Đồng phục trường"
        ],
        "answer": 1,
    ...
    {
        "question": "Có bao nhiêu lá thư trong hộp quà?",
        "options": [
            "30 lá",
            "35 lá",
            "40 lá",
    ...
    {
        "question": "Phản ứng của cô giáo khi nhận quà như thế nào?",
        "options": [
            "Cô rất giận",
            "Cô mỉm cười và cảm ơn",
            "Đôi má cô ửng hồng vì xúc động",
            "Cô mở quà ra đọc ngay"
        ],
        "answer": 2,
        "level": 1
    },
    {
        "question": "Tại sao thư được giữ bí mật tuyệt đối?",
        "options": [
            "Vì đó là tình cảm riêng tư của mỗi học sinh",
            "Vì chiếc hộp bị khóa",
            "Vì các bạn không muốn cô biết",
            "Vì thư viết chưa xong"
        ],
        "answer": 0,
        "level": 1
    },
    {
        "question": "Nhan đề nào khác phù hợp với câu chuyện?",
        "options": [
            "Chiếc hộp màu xanh",
            "Món quà từ trái tim",
            "Lá thư của Tân",
    ...
    {
        "question": "Tác giả của câu chuyện là ai?",
        "options": [
            "Nguyễn Thu Hằng",
            "Trần Đăng Khoa",
            "Tô Hoài",
    ...
    {
        "question": "Màu thiên thanh là màu gì?",
        "options": [
            "Màu xanh lá",
            "Màu xanh da trời",
            "Màu đỏ thắm",
    ...
    {
        "question": "Câu chuyện ca ngợi điều gì?",
        "options": [
            "Lao động là vinh quang",
            "Tình cảm thầy trò thân thiết, biết ơn",
            "Tình bạn gắn bó",
            "Sự chăm chỉ học tập"
        ],
        "answer": 1,
...
if (!lesson_202_hop_qua_mau_thien_thanh.period) lesson_202_hop_qua_mau_thien_thanh.period = "202";
if (!lesson_202_hop_qua_mau_thien_thanh.id) lesson_202_hop_qua_mau_thien_thanh.id = "202-hop-qua-mau-thien-thanh";
