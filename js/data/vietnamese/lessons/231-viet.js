...
<div class="space-y-8 animate-in fade-in duration-700">
                        ...
                        <section class="w-full">
                            <div class="glass-card rounded-[40px] p-6 md:p-10 shadow-2xl relative overflow-hidden ring-1 ring-blue-100">
                                ...
                                <div class='bg-blue-50/80 p-4 rounded-[24px] border border-blue-200 text-blue-800 text-base font-bold flex items-center gap-3 mb-8 animate-in slide-in-from-left-4'>
                                    <span>💡 Mẹo: Em có thể nhấn vào nút 🎙️ xuất hiện cạnh các ô nhập liệu để trả lời bằng giọng nói cho nhanh nhé!</span>
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1a">
                                        <p class="font-bold text-blue-800 mb-3 flex items-center gap-2">
                                            <span>a. Đoạn văn nói đến sự việc gì? Người viết có ấn tượng chung về sự việc đó thế nào?</span>
                                            <button onclick="toggleSpeech('ai-v231-1a')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                        </p>
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex gap-2">
                                                <button onclick="checkParagraphAI('v231-1a')" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl text-sm border-0 shadow-md active:scale-95 transition-all flex items-center gap-2">
                                                    <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                                    <span>KIỂM TRA (a)</span>
                                                </button>
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1b">
                                        ...
                                        <div class="mt-4 flex gap-2">
                                            <button onclick="check231Viet_1b()" class="px-5 py-2 bg-indigo-600 text-white font-bold rounded-xl shadow-md border-0 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-indigo-600 font-black text-[10px] shadow-sm">E</div>
                                                <span>KIỂM TRA (b)</span>
                                            </button>
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1c">
                                        <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                            <span>c. Trong phần triển khai, những chi tiết nào nói về ngày hội gây được ấn tượng với người viết?</span>
                                            <button onclick="toggleSpeech('ai-v231-1c')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                        </p>
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex gap-2">
                                                <button onclick="checkParagraphAI('v231-1c')" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl text-sm border-0 shadow-md active:scale-95 transition-all flex items-center gap-2">
                                                    <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                                    <span>KIỂM TRA (c)</span>
                                                </button>
                                    ...
                                    <div class="bg-white rounded-2xl p-5 border border-blue-100 mb-6" id="block-v231-1d">
                                        <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                            <span>d. Tình cảm, cảm xúc của người viết được bộc lộ qua những từ ngữ, câu văn nào?</span>
                                            <button onclick="toggleSpeech('ai-v231-1d')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                        </p>
                                        <div class="flex flex-col gap-2">
                                            ...
                                            <div class="flex gap-2">
                                                <button onclick="checkParagraphAI('v231-1d')" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl text-sm border-0 shadow-md active:scale-95 transition-all flex items-center gap-2">
                                                    <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                                    <span>KIỂM TRA (d)</span>
                                                </button>
                                ...
                                <div class="mb-8" id="block-v231-ex2">
                                    ...
                                    <div class="space-y-4 bg-blue-600/5 rounded-3xl p-6 border-2 border-dashed border-blue-200">
                                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-blue-100">
                                            <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                                <span>1. Đoạn văn thường có mấy phần? Đó là những phần nào?</span>
                                                <button onclick="toggleSpeech('v231-ex2-1')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        ...
                                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-blue-100">
                                            <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                                <span>2. Nội dung phần Mở đầu là gì?</span>
                                                <button onclick="toggleSpeech('v231-ex2-2')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        ...
                                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-blue-100">
                                            <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                                <span>3. Nội dung phần Triển khai là gì?</span>
                                                <button onclick="toggleSpeech('v231-ex2-3')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        ...
                                        <div class="bg-white p-5 rounded-2xl shadow-sm border border-blue-100">
                                            <p class="font-bold text-blue-800 mb-2 flex items-center gap-2">
                                                <span>4. Nội dung phần Kết thúc là gì?</span>
                                                <button onclick="toggleSpeech('v231-ex2-4')" class="p-1.5 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-all text-xs shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        ...
                                        <div class="mt-4 flex gap-3">
                                            <button onclick="check231Viet_Ex2()" class="px-5 py-2 bg-blue-600 text-white font-bold rounded-xl shadow-md border-0 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-blue-600 font-black text-[10px] shadow-sm">E</div>
                                ...
                                <div class="space-y-8">
                                    <div class="bg-white rounded-3xl p-6 shadow-sm border border-indigo-100" id="block-v231-lt1">
                                        <div class="flex items-start gap-4 mb-4">
                                            ...
                                            <p class="text-xl font-bold text-gray-800 leading-relaxed flex items-center gap-3">
                                                <span>Nói với người thân về một việc em đã làm được trong ngày. Nêu tình cảm, cảm xúc của em khi thực hiện và hoàn thành công việc đó.</span>
                                                <button onclick="toggleSpeech('ai-v231-lt1')" class="p-2 bg-indigo-100 text-indigo-600 rounded-full hover:bg-indigo-200 transition-all text-sm shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                            </p>
                                        </div>
                                        ...
                                        <div class="mt-3 flex gap-3">
                                            <button onclick="checkParagraphAI('v231-lt1')" class="px-5 py-2 bg-indigo-600 text-white font-bold rounded-xl shadow-md border-0 active:scale-95 transition-all flex items-center gap-2">
                                                <div class="w-5 h-5 bg-white rounded flex items-center justify-center text-indigo-600 font-black text-[10px] shadow-sm">E</div>
                                                <span>CHẤM BÀI</span>
                                            </button>
                                    ...
                                    <div class="bg-white rounded-3xl p-6 shadow-sm border border-indigo-100" id="block-v231-lt2">
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <button onclick="toggleSpeech('v231-lt2-book')" class="p-2 bg-amber-100 text-amber-700 rounded-full hover:bg-amber-200 transition-all text-sm shadow-sm" title="Nhập bằng giọng nói">🎙️</button>
                                        </div>
                                        <div class="mt-4 flex gap-3">
                                            <button onclick="checkAI_231Viet()" class="px-8 py-3 bg-rose-600 text-white text-lg font-black rounded-2xl shadow-lg hover:bg-rose-700 active:scale-95 flex items-center gap-2">
