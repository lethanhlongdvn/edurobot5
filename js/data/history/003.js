export const lesson003 = {
    ...
    "desc": "Khám phá đặc điểm tự nhiên và địa hình Việt Nam.",
    "content": `
        <div class="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-amber-600 via-yellow-500 to-orange-400 p-8 md:p-12 mb-8 text-white shadow-2xl">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-3xl md:text-4xl font-black mb-3 leading-tight">Bài 2: Thiên nhiên Việt Nam</h1>
                <p class="text-lg md:text-xl font-bold opacity-90 max-w-2xl leading-relaxed">Khám phá đặc điểm tự nhiên và địa hình Việt Nam.</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[32px] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-slate-700 mb-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <h2 class="text-2xl font-black text-gray-800 dark:text-slate-100">Bài 2: Thiên nhiên Việt Nam</h2>
            </div>
            <div class="p-6 bg-gray-50 dark:bg-slate-700/50 rounded-2xl border-2 border-dashed border-gray-200 dark:border-slate-600 text-center">
                ...
                <p class="text-sm font-bold text-gray-400 dark:text-slate-500 mt-2">Tuần 2 • Tiết 3</p>
            </div>
        </div>
    `,
    "practice": `
