export const lesson061 = {
    "topic": "Lịch sử & Địa lý thế giới",
    "week": "31",
    "period": "61",
    "title": "Bài 23: Dân số và các chủng tộc trên thế giới (Tiết 2)",
    "desc": "Các chủng tộc trên thế giới và sự đa dạng văn hoá.",
    "content": `
        <div class="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-indigo-600 via-purple-500 to-blue-400 p-8 md:p-12 mb-8 text-white shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-4 text-sm font-black uppercase tracking-widest backdrop-blur-sm">
                    <span>🌐</span> Lịch sử & Địa lý thế giới
                </div>
                <h1 class="text-3xl md:text-4xl font-black mb-3 leading-tight">Bài 23: Dân số và các chủng tộc trên thế giới</h1>
                <p class="text-lg md:text-xl font-bold opacity-90 max-w-2xl leading-relaxed">Các chủng tộc trên thế giới và sự đa dạng văn hoá.</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[32px] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-slate-700 mb-6">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-indigo-100 text-indigo-600 rounded-2xl flex items-center justify-center text-2xl font-black">📖</div>
                <h2 class="text-2xl font-black text-gray-800 dark:text-slate-100">Bài 23: Dân số và các chủng tộc trên thế giới</h2>
            </div>
            <div class="p-6 bg-gray-50 dark:bg-slate-700/50 rounded-2xl border-2 border-dashed border-gray-200 dark:border-slate-600 text-center">
                ...
                <p class="text-sm font-bold text-gray-400 dark:text-slate-500 mt-2">Tuần 31 • Tiết 61</p>
            </div>
        </div>
    `,
    "practice": `
