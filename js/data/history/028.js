export const lesson028 = {
    "topic": "Lịch sử Việt Nam",
    "week": "14",
    "period": "28",
    "title": "Bài 10: Triều Trần xây dựng đất nước và kháng chiến chống quân Mông - Nguyên xâm lược (Tiết 4)",
    "desc": "Ý nghĩa lịch sử của ba lần kháng chiến chống quân Mông - Nguyên.",
    "content": `
        <div class="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-red-700 via-rose-600 to-amber-500 p-8 md:p-12 mb-8 text-white shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-4 text-sm font-black uppercase tracking-widest backdrop-blur-sm">
                    <span>🏛️</span> Lịch sử Việt Nam
                </div>
                <h1 class="text-3xl md:text-4xl font-black mb-3 leading-tight">Bài 10: Triều Trần xây dựng đất nước và kháng chiến chống quân Mông - Nguyên xâm lược</h1>
                <p class="text-lg md:text-xl font-bold opacity-90 max-w-2xl leading-relaxed">Ý nghĩa lịch sử của ba lần kháng chiến chống quân Mông - Nguyên.</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[32px] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-slate-700 mb-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <h2 class="text-2xl font-black text-gray-800 dark:text-slate-100">Bài 10: Triều Trần xây dựng đất nước và kháng chiến chống quân Mông - Nguyên xâm lược</h2>
            </div>
            <div class="p-6 bg-gray-50 dark:bg-slate-700/50 rounded-2xl border-2 border-dashed border-gray-200 dark:border-slate-600 text-center">
                ...
                <p class="text-sm font-bold text-gray-400 dark:text-slate-500 mt-2">Tuần 14 • Tiết 28</p>
            </div>
        </div>
    `,
    "practice": `
