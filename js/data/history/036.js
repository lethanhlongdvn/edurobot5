export const lesson036 = {
    "topic": "Kiểm tra",
    "week": "18",
    "period": "36",
    "title": "Kiểm tra và đánh giá cuối học kỳ I",
    "desc": "Kiểm tra đánh giá cuối học kỳ I.",
    "content": `
        <div class="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-slate-700 via-gray-600 to-zinc-500 p-8 md:p-12 mb-8 text-white shadow-2xl">
            ...
            <div class="relative z-10">
                <div class="inline-flex items-center gap-2 bg-white/20 px-4 py-2 rounded-full mb-4 text-sm font-black uppercase tracking-widest backdrop-blur-sm">
                    <span>✅</span> Kiểm tra & Đánh giá
                </div>
                <h1 class="text-3xl md:text-4xl font-black mb-3 leading-tight">Kiểm tra và đánh giá cuối học kỳ I</h1>
                <p class="text-lg md:text-xl font-bold opacity-90 max-w-2xl leading-relaxed">Kiểm tra đánh giá cuối học kỳ I.</p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-slate-800 rounded-[32px] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-slate-700 mb-6">
            <div class="flex items-center gap-3 mb-6">
                <div class="w-12 h-12 bg-gray-100 text-gray-600 rounded-2xl flex items-center justify-center text-2xl font-black">📖</div>
                <h2 class="text-2xl font-black text-gray-800 dark:text-slate-100">Kiểm tra và đánh giá cuối học kỳ I</h2>
            </div>
            <div class="p-6 bg-gray-50 dark:bg-slate-700/50 rounded-2xl border-2 border-dashed border-gray-200 dark:border-slate-600 text-center">
                ...
                <p class="text-sm font-bold text-gray-400 dark:text-slate-500 mt-2">Tuần 18 • Tiết 36</p>
            </div>
        </div>
    `,
    "practice": `
