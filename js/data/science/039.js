export const lesson039 = {
    ...
    "week": "20",
    "period": "39",
    "title": "BÀI 18: VI KHUẨN XUNG QUANH CHÚNG TA (TIẾT 2)",
    "desc": "Bài học Khoa học tuần 20, tiết 39.",
    "content": `
        <div class="space-y-4 text-emerald-900">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-6 rounded-[32px] shadow-xl flex items-center gap-4 text-white">
                ...
                <div>
                    <h3 class="text-2xl font-black italic">Bài 18: Vi khuẩn xung quanh chúng ta (tiết 2)</h3>
