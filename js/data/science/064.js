export const lesson064 = {
    ...
    "week": "32",
    "period": "64",
    "title": "BÀI 28: CHỨC NĂNG CỦA MÔI TRƯỜNG ĐỐI VỚI SINH VẬT (TIẾT 4)",
    "desc": "Bài học Khoa học tuần 32, tiết 64.",
    "content": `
        <div class="space-y-4 text-emerald-900">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-6 rounded-[32px] shadow-xl flex items-center gap-4 text-white">
                ...
                <div>
                    <h3 class="text-2xl font-black italic">Bài 28: Chức năng của môi trường đối với sinh vật (tiết 4)</h3>
