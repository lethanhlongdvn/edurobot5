export const lesson066 = {
    ...
    "week": "33",
    "period": "66",
    "title": "BÀI 29: TÁC ĐỘNG CỦA CON NGƯỜI VÀ MỘT SỐ BIỆN PHÁP BẢO VỆ MÔI TRƯỜNG (TIẾT 2)",
    "desc": "Bài học Khoa học tuần 33, tiết 66.",
    "content": `
        <div class="space-y-4 text-emerald-900">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-6 rounded-[32px] shadow-xl flex items-center gap-4 text-white">
                ...
                <div>
                    <h3 class="text-2xl font-black italic">Bài 29: Tác động của con người và một số biện pháp bảo vệ môi trường (tiết 2)</h3>
