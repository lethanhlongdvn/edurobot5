export const lesson041 = {
    ...
    "week": "21",
    "period": "41",
    "title": "BÀI 19: VI KHUẨN CÓ ÍCH TRONG CHẾ BIẾN THỰC PHẨM (TIẾT 2)",
    "desc": "Bài học Khoa học tuần 21, tiết 41.",
    "content": `
        <div class="space-y-4 text-emerald-900">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-6 rounded-[32px] shadow-xl flex items-center gap-4 text-white">
                ...
                <div>
                    <h3 class="text-2xl font-black italic">Bài 19: Vi khuẩn có ích trong chế biến thực phẩm (tiết 2)</h3>
