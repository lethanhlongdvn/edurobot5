export const lesson033 = {
    ...
    "week": "17",
    "period": "33",
    "title": "BÀI 16: VÒNG ĐỜI VÀ SỰ PHÁT TRIỂN CỦA ĐỘNG VẬT (TIẾT 1)",
    "desc": "Bài học Khoa học tuần 17, tiết 33.",
    "content": `
        <div class="space-y-4 text-emerald-900">
            <div class="bg-gradient-to-r from-emerald-600 to-teal-700 p-6 rounded-[32px] shadow-xl flex items-center gap-4 text-white">
                ...
                <div>
                    <h3 class="text-2xl font-black italic">Bài 16: Vòng đời và sự phát triển của động vật (tiết 1)</h3>
